...
public class FJExperiment {
    public static void main(String[] args) {
        ...
        if (args.length != 2) {
            System.out.println("Usage: FJExperiment parallelism edge");
            return;
        }
        ...
        System.out.println("Limit of sequential workaround: " + threshold);
        System.out.println("Time elapsed: " + (endT - beginT) + " nanoseconds");
        System.out.println();
    }
}
